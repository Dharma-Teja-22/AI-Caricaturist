...
const ConsentStep = ({ setStep, setUserData }) => {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-miracle-white text-miracle-black shadow-lg rounded-lg p-8 text-center">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-miracle-black mb-6">
